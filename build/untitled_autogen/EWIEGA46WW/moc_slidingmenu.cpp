...
QT_MOC_LITERAL(6, 58, 17), // "userMenuRequested"
QT_MOC_LITERAL(7, 76, 5), // "point"
QT_MOC_LITERAL(8, 82, 19), // "onAnimationFinished"
QT_MOC_LITERAL(9, 102, 14), // "onCloseClicked"
QT_MOC_LITERAL(10, 117, 16), // "updateMenuHeight"
QT_MOC_LITERAL(11, 134, 14), // "toggleUserMenu"
QT_MOC_LITERAL(12, 149, 10) // "menuOffset"

    },
    "SlidingMenu\0menuShown\0\0menuHidden\0"
    "checkBoxToggled\0checked\0userMenuRequested\0"
    "point\0onAnimationFinished\0onCloseClicked\0"
    "updateMenuHeight\0toggleUserMenu\0"
    "menuOffset"
};
...
void SlidingMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->userMenuRequested((*reinterpret_cast< const QPoint(*)>(_a[1]))); break;
        case 4: _t->onAnimationFinished(); break;
        case 5: _t->onCloseClicked(); break;
        case 6: _t->updateMenuHeight(); break;
        case 7: _t->toggleUserMenu(); break;
        default: ;
        }
        ...
        {
            using _t = void (SlidingMenu::*)(const QPoint & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SlidingMenu::userMenuRequested)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 3
void SlidingMenu::userMenuRequested(const QPoint & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
