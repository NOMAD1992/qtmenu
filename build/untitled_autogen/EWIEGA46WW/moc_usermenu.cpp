...
QT_MOC_LITERAL(1, 9, 9), // "menuShown"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 10), // "menuHidden"
QT_MOC_LITERAL(4, 31, 19), // "onAnimationFinished"
QT_MOC_LITERAL(5, 51, 18), // "updateMenuGeometry"
QT_MOC_LITERAL(6, 70, 10) // "menuOffset"

    },
    "UserMenu\0menuShown\0\0menuHidden\0"
    "onAnimationFinished\0updateMenuGeometry\0"
    "menuOffset"
};
...
void UserMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->updateMenuGeometry(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (UserMenu::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UserMenu::menuShown)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (UserMenu::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UserMenu::menuHidden)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void UserMenu::menuShown()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void UserMenu::menuHidden()
{
