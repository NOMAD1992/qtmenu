...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_7 = new QPushButton(fWorkArea);
        ...
        pushButton_8 = new QPushButton(fWorkArea);
        pushButton_8->setObjectName(QString::fromUtf8("pushButton_8"));

        horizontalLayout_3->addWidget(pushButton_8);

        pushButton_9 = new QPushButton(fWorkArea);
        ...
        pushButton_10 = new QPushButton(fWorkArea);
        ...
        pushButton_11 = new QPushButton(fWorkArea);
        pushButton_11->setObjectName(QString::fromUtf8("pushButton_11"));

        horizontalLayout_4->addWidget(pushButton_11);

        pushButton_12 = new QPushButton(fWorkArea);
        ...
        pushButton = new QPushButton(fWorkArea);
        ...
        pushButton_2 = new QPushButton(fWorkArea);
        pushButton_2->setObjectName(QString::fromUtf8("pushButton_2"));

        horizontalLayout->addWidget(pushButton_2);

        pushButton_3 = new QPushButton(fWorkArea);
        ...
        pushButton_13 = new QPushButton(fWorkArea);
        ...
        pushButton_14 = new QPushButton(fWorkArea);
        pushButton_14->setObjectName(QString::fromUtf8("pushButton_14"));

        horizontalLayout_5->addWidget(pushButton_14);

        pushButton_15 = new QPushButton(fWorkArea);
        ...
        pushButton_16 = new QPushButton(fWorkArea);
        ...
        pushButton_17 = new QPushButton(fWorkArea);
        pushButton_17->setObjectName(QString::fromUtf8("pushButton_17"));

        horizontalLayout_6->addWidget(pushButton_17);

        pushButton_18 = new QPushButton(fWorkArea);
        ...
        pushButton_4 = new QPushButton(fWorkArea);
        ...
        pushButton_5 = new QPushButton(fWorkArea);
        pushButton_5->setObjectName(QString::fromUtf8("pushButton_5"));

        horizontalLayout_2->addWidget(pushButton_5);

        pushButton_6 = new QPushButton(fWorkArea);
        ...
        pushButton_19 = new QPushButton(fWorkArea);
        ...
        pushButton_20 = new QPushButton(fWorkArea);
        pushButton_20->setObjectName(QString::fromUtf8("pushButton_20"));

        horizontalLayout_7->addWidget(pushButton_20);

        pushButton_21 = new QPushButton(fWorkArea);
        ...
        pushButton_22 = new QPushButton(fWorkArea);
        ...
        pushButton_23 = new QPushButton(fWorkArea);
        pushButton_23->setObjectName(QString::fromUtf8("pushButton_23"));

        horizontalLayout_8->addWidget(pushButton_23);

        pushButton_24 = new QPushButton(fWorkArea);
